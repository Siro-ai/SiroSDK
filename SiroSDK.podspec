Pod::Spec.new do |s|
	...
	s.source 			 					 = { :git => "https://github.com/Siro-ai/SiroSDK.git", :tag => "1.3.15" }
	s.platform 		 					 = :ios
	s.ios.deployment_target  = '15.0'
	s.vendored_frameworks 	 = "ios/SiroSDK.xcframework"

	s.dependency 'FirebaseAuth', '~> 10'
	s.dependency 'FirebaseDynamicLinks', '~> 10'
	s.dependency 'FirebaseFirestore', '~> 10'
	s.dependency 'FirebaseFirestoreSwift', '~> 10'
	s.dependency 'FirebaseStorage', '~> 10'
	s.dependency 'Mixpanel', '~> 4'
end
